...
// 	);
	...
	*/
	...
	//rejestracja custom type - zastosowania na index page
		...
		// $services_category_args = array(
		// array('systemy'), /* if you change the name of register_post_type( 'custom_type', then you have to change this */
		// array('hierarchical' => true,     /* if this is true, it acts like categories */
		// 	'labels' => array(
		// 		'name' => __( 'Custom Categories', 'bonestheme' ), /* name of the custom taxonomy */
		// 		'singular_name' => __( 'Custom Category', 'bonestheme' ), /* single taxonomy name */
		...
		// 	'show_ui' => true,
		// 	'query_var' => true,
		// 	'rewrite' => array( 'slug' => 'systemy' ),
		// )
		// );
	
	
		//rejestracja custom type - referencje na index page
		// $blog_args = array(
		// 	'labels' => array(
		// 		'name' => 'Blog',
		// 		'singular_name' => 'Blog',
